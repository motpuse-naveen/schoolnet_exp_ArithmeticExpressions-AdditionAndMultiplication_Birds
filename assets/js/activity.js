...
function newQuestion() {
  ...
  for (var k = 0; k <= 4; k++) {
    ...
    $(screenTextArray[k]).find(".expr-text").html("" + birdCountArray[birdOrderArray[k]] + " " + birdPluralArray[birdOrderArray[k]]);
  }
...
$("#explain_btn").on("click", function () {
  ...
  for (var k = 0; k <= 4; k++) {
    ...
    $(explainTextArray[k]).html("" + birdCountArray[birdOrderArray[k]] + " " + birdPluralArray[birdOrderArray[k]]);
    ...
    col.append($("<p class='bold birdtext'>").html("" + birdCountArray[birdOrderArray[k]] + " " + birdPluralArray[birdOrderArray[k]]));
  }
